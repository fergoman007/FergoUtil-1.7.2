...
public abstract class ItemPickaxeFergo extends ItemPickaxe
{
    public int mod;
    public Item repairItem;
    public ToolMaterial material;

    public ItemPickaxeFergo(ToolMaterial material, int mod, CreativeTabs tab, Item repairItem, String name)
    {
        super(material);
