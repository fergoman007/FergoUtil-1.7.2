...
public class WorldGenEndMinable extends WorldGenerator
{
	...
	public WorldGenEndMinable(IBlockState oreBlock, int numberOfBlocks)
	{
		this(oreBlock, numberOfBlocks, BlockHelper.forBlock(Blocks.netherrack));
	}
	
	public WorldGenEndMinable(IBlockState oreBlock, int numberOfBlocks, Predicate predicate)
	{
