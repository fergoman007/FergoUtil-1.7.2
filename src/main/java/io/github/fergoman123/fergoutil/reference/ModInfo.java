...
public class ModInfo
{
    ...
    public static final String updateUrl = "fergoman123.github.io/fergoutil";
    public static final String desc = "Fergoman123's Util is a utility mod thats is used to register events, items, blocks and other things";
